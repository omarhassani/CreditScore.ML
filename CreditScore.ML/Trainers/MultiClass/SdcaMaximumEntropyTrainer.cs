...
{
    public class SdcaMaximumEntropyTrainer : ITrainerProcess
    {
        private readonly string _modelPath = @"../../../..";
        private readonly MLContext _mlContext;
        private string trainer = "SdcaMaximumEntropy";
        public SdcaMaximumEntropyTrainer(MLContext mlContext)
        {
        ...
        public IEstimator<ITransformer> BuildPipeline()
        {
            ...
            var pipeline = _mlContext.Transforms.ReplaceMissingValues(new[] { new InputOutputColumnPair(@"V1", @"V1"), new InputOutputColumnPair(@"V2", @"V2"), new InputOutputColumnPair(@"V3", @"V3"), new InputOutputColumnPair(@"V4", @"V4"), new InputOutputColumnPair(@"V5", @"V5"), new InputOutputColumnPair(@"V6", @"V6"), new InputOutputColumnPair(@"V7", @"V7"), new InputOutputColumnPair(@"V8", @"V8"), new InputOutputColumnPair(@"V9", @"V9"), new InputOutputColumnPair(@"V10", @"V10"), new InputOutputColumnPair(@"V11", @"V11"), new InputOutputColumnPair(@"V12", @"V12"), new InputOutputColumnPair(@"V13", @"V13") })
                                    ...
                                    .Append(_mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(l1Regularization: 6.72309249881187F, l2Regularization: 0.63066019548707F, labelColumnName: @"Label", featureColumnName: @"Features"))
        ...
        public void Process(IDataView trainingDataView, IDataView validationDataView = null)
        {
            ...
            var pipeline = _mlContext.Transforms
                ...
                .Append(_mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(l1Regularization: 6.72309249881187F, l2Regularization: 0.63066019548707F, featureColumnName: @"Features"));
            ...
            //CalibratedBinaryClassificationMetrics metrics = _mlContext.MulticlassClassification.Evaluate(data: predictions, labelColumnName: "Label");
            ...
            #region "Permutation Feature Importance"
