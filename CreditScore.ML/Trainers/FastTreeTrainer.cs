...
{
    public class FastTreeTrainer : ITrainerProcess
    {
        ...
        public void Process(IDataView trainingDataView, IDataView validationDataView = null)
        {
            ...
            (string name, IEstimator<ITransformer> value) trainingModel = ("FastTree", _mlContext.BinaryClassification.Trainers.FastTree(labelColumnName: "Label", featureColumnName: "Features"));
            ...
            //string modelPath = trainersAgregator.GenerateTrainersModelCrossValidation(trainingDataView, trainingModel, pipelineBase);
            ...
            //        // normalized data.
            //        var permutationMetrics_ranking = _mlContext.Ranking
            //            .PermutationFeatureImportance(linearPredictor, transformedData, labelColumnName: "Label", permutationCount: 30);

            //        var sortedIndices_ranking = permutationMetrics_ranking.Select((metrics, index) => new {
            //            index,
            ...
            //        var ndcg = permutationMetrics_ranking.Select(
            //            x => x.NormalizedDiscountedCumulativeGains).ToArray();
            //        foreach (int i in sortedIndices_ranking)
            //        {
