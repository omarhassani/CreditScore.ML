...
{
    public class AveragedPerceptronTrainer : ITrainerProcess
    {
        private static readonly string _modelPath = @"../../../..";
        private readonly MLContext _mlContext;
        public AveragedPerceptronTrainer(MLContext mlContext)
        {
        ...
        public void Process(IDataView trainingDataView, IDataView validationDataView = null)
        {
            ...
            (string name, IEstimator<ITransformer> value) trainingModel = ("AveragedPerceptron", _mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "Label", featureColumnName: "Features"));
        ...
        private void Featurize(IDataView trainingDataView, (string name, IEstimator<ITransformer> value) trainingModel, string[] featureColumns, EstimatorChain<NormalizingTransformer> pipelineBase)
        {
            var pipeline = pipelineBase
                            .Append(_mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "Label"));
